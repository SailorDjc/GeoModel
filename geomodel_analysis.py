                    ...
                    if self.terrain_data is not None:
                        if self.terrain_data.vtk_data is None:
                            if self.terrain_data.is_empty():
                                ...
                                bottom_points = sample_data.get_bottom_points()
                                self.terrain_data.set_control_points(control_points=top_points)
                                self.terrain_data.set_bottom_control_points(control_points=bottom_points)
                            self.terrain_data.execute(resolution_xy=2, extend_buffer=10)
